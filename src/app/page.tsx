...
//           {dueCount > 0 && (
//             <div className="mb-16">
//               <div className="max-w-3xl mx-auto bg-gradient-to-br from-blue-900/50 to-cyan-900/50 backdrop-blur-xl border border-blue-500/30 rounded-3xl p-6 sm:p-12">
...
//                         {dueCount}
//                       </span>{' '}
//                       {dueCount === 1 ? 'palavra' : 'palavras'} para revisar
//                       hoje
//                     </p>
//                     <p className="text-gray-500 text-xs sm:text-sm">
//                       💡 Revisões espaçadas ajudam você a lembrar por mais
//                       tempo!
//                     </p>
//                   </div>
...
//                       <Button
//                         size="lg"
//                         className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-bold text-lg px-8 hover:from-blue-500 hover:to-cyan-500 shadow-xl"
...
//                     startContent={<BookOpen className="w-5 h-8" />}
//                   >
//                     Todos os Flashcards
//                   </Button>
//                 </Link>
...
//                     startContent={<Trophy className="w-5 h-8" />}
//                   >
//                     Quiz Completo
//                   </Button>
//                 </Link>
